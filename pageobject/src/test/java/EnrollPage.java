...
//        this.wait = new WebDriverWait(driver, 15);
    ...
    private String inputName = "//input[@name='name']"; //"//input[@name = 'name']";
...
//        driver.findElement(By.xpath(signUp)).click();
    ...
    public void enterName(String name) {
        WebElement nameInput = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(inputName)));
        nameInput.clear();  // на всякий случай
